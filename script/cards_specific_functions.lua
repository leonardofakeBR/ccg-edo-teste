...
-- Okami spell/trap condition
function Auxiliary.okamicon(e,tp,eg,ep,ev,re,r,rp)
		return Duel.GetFieldGroupCount(tp,LOCATION_MZONE,0)>0
			and Duel.IsExistingMatchingCard((c:IsFaceup() and (c:IsCode(444000000) or c:IsCode(444000050))),tp,LOCATION_MZONE,0,1,nil)
	end
